    ...
    <main className="layout">
      ...
      <section>
        <div className="mt-3 text-center">
          ...
          <p>A full-strack blog made white Next.js, TailwindCSS, Github GraphQL</p>
        </div>
      </section>
      <section className="flex flex-col items-center text-[1.15rem] mt-12">
        <div className="flex gap-3 mb-12">
          ...
          {filteredBlogs.map((blog: BlogPost) => {
            return (
              <div className="max-w-[28em] max-h-[20em] overflow-hidden mx-6 mb-6 bg-neutral-300 text-zinc-800 rounded-lg p-4 hover:bg-neutral-500 hover:text-neutral-300 transition-all duration-300" key={blog.id}>
